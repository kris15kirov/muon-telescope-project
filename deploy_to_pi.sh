...
ssh $PI_USER@$PI_IP << 'EOF'
    ...
    echo "   1. Connect to your home network"
    echo "   2. Open browser: https://192.168.100.36/control/"
...
echo "2. Connect to your home network"
echo "3. Access web interface: https://192.168.100.36/control/"
