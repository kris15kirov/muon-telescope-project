...
ssh $PI_USER@$PI_IP << 'EOF'
    ...
    echo "   1. Connect to Wi-Fi: Muon Telescope (password: muon123456)"
    echo "   2. Open browser: http://192.168.4.1:8000"
...
echo "2. Connect to Wi-Fi: Muon Telescope (password: muon123456)"
echo "3. Access web interface: http://192.168.4.1:8000"
